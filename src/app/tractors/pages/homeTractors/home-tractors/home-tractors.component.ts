...
export class HomeTractorsComponent implements OnInit, OnInit{
  ...
  @HostListener('window:scroll') onScroll(e: Event): void {
    ...
    (this.getYPosition(e) >= 30 ) ? this.scroll2 = true : this.scroll2 = false;
    (this.getYPosition(e) >= 47 ) ? this.scroll3 = true : this.scroll3 = false;
    (this.getYPosition(e) >= 67 ) ? this.scroll4 = true : this.scroll4 = false;
    (this.getYPosition(e) >= 80 ) ? this.scroll5 = true : this.scroll5 = false;
    (this.getYPosition(e) >= 93 ) ? this.scroll6 = true : this.scroll6 = false;
